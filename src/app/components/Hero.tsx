  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-6xl mx-auto pt-20 px-4 sm:px-6 lg:px-12 text-center">
        ...
        <p className="animate-fade-up opacity-0 delay-400 mt-8 sm:mt-10 font-body text-base sm:text-lg md:text-2xl text-foreground/60 max-w-4xl mx-auto leading-relaxed font-light">
          Where precision meets innovation, engineering tomorrow&apos;s solutions
          with intellectual rigor and a global vision.
        </p>

        <div className="animate-fade-up opacity-0 delay-600 mt-8 sm:mt-12 flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-5">
          <Link
            href="/research"
            className="group relative px-8 sm:px-10 py-3.5 sm:py-4 bg-amber text-graphite-deep font-display font-bold text-xs sm:text-sm tracking-widest rounded-sm overflow-hidden transition-all duration-300 hover:shadow-[0_0_40px_rgba(213,156,16,0.3)]"
          >
